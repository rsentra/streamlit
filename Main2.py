### models폴더에 있는 brain.py를 이용하여 pdf load 챗봇임 

import streamlit as st
import openai
from  models.brain import get_index_for_pdf
...
openai.api_key = st.secrets["opai_api_key"]['api_key']
...
if question:
    ...
    print("search result : ", pdf_extract)
